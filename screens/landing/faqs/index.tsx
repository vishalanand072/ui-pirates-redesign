...
const LandingFaqs = () => {
  return (
    <div className="container mx-auto grid grid-cols-4 max-lg:grid-cols-4 max-md:grid-cols-1 max-md:px-4 lg:px-20 mt-32">
      {/* Left section - Sticky */}
      ...
      <div className="col-span-2 max-lg:col-span-2 max-md:col-span-1 max-md:mt-4  mt-40">
