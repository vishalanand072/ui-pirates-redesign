...
export const Navbar = () => {
  return (
    <NextUINavbar
      maxWidth="xl"
      position="sticky"
      className="bg-none mx-[22rem] blur-none py-0 w-auto px-0 max-lg:mx-20 max-md:mx-0 max-xl:mx-40
      ...
      >
        <NavbarItem className="hidden md:flex">
          <Button
            isExternal
            as={Link}
            className="text-sm font-normal text-white bg-black pt-0 dark:bg-white dark:text-black -mr-4"
